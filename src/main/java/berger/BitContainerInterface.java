...
public interface BitContainerInterface {
    ...
    /* flip 0 to 1 or 1 to 0 on given (index+1)th bit.
    Returns false is addressing invalid index*/
    boolean flipBit(int index);

    /* set  (index+1)th bit as 1. Returns false is addressing invalid index*/
    boolean setBit(int index);

    /* set  (index+1)th bit as 0. Returns false is addressing invalid index*/
    boolean clearBit(int index);

    /* Returns value of (index+1)th bit*/
